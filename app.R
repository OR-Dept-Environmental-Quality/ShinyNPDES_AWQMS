...
#we could probably save a lot of time if I made a NPDES specific chars function 
#or just did a list like for HUC names- NPDES characteristics don't really change
chars <- AWQMS_Chars()
chars <- chars$Char_Name
chars <- sort(chars)


#changed to just the station types NPDES would be interested in (see function for details)

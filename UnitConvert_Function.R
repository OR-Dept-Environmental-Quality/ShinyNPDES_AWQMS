...
#designed for Copper BLM, so focuses on temperature, ang ug-mg conversions
#note that this function only transforms RESULTS, it does not transform MDLs or MRLs
